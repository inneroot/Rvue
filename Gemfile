...
# Turbolinks makes navigating your web application 
#faster. Read more: https://github.com/turbolinks/turbolinks
gem 'turbolinks', '~> 5'
...
gem 'ckeditor_rails' # Editor
gem 'kaminari' #pagination
gem 'sanitize' #HTML cut
gem 'acts_as_list', :git => 'git://github.com/swanandp/acts_as_list.git' 
# Sorting list of dependent objects
